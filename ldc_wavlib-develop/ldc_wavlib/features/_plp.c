...
#endif
#include <math.h>
#define __PYX_HAVE__ldc_wavlib__features___plp
#define __PYX_HAVE_API__ldc_wavlib__features___plp
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
struct __pyx_opt_args_10ldc_wavlib_8features_4_plp_levinson;

/* "ldc_wavlib/features/_plp.pyx":51
...
/* Module declarations from 'ldc_wavlib.features._plp' */
...
static PyObject *__pyx_f_10ldc_wavlib_8features_4_plp_acorr(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_10ldc_wavlib_8features_4_plp_levinson(__Pyx_memviewslice, int __pyx_skip_dispatch, struct __pyx_opt_args_10ldc_wavlib_8features_4_plp_levinson *__pyx_optional_args); /*proto*/
static PyObject *__pyx_f_10ldc_wavlib_8features_4_plp_lpc_2_cepstrum(__Pyx_memviewslice, __Pyx_memviewslice, unsigned int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "ldc_wavlib.features._plp"
int __pyx_module_is_main_ldc_wavlib__features___plp = 0;

/* Implementation of 'ldc_wavlib.features._plp' */
...
static PyObject *__pyx_pf_10ldc_wavlib_8features_4_plp_acorr(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x); /* proto */
static PyObject *__pyx_pf_10ldc_wavlib_8features_4_plp_2levinson(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_r, PyObject *__pyx_v_n); /* proto */
static PyObject *__pyx_pf_10ldc_wavlib_8features_4_plp_4lpc_2_cepstrum(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_acoeff, __Pyx_memviewslice __pyx_v_e, unsigned int __pyx_v_n_ceps); /* proto */
...
static char __pyx_k_acoeff[] = "acoeff";
static char __pyx_k_format[] = "format";
static char __pyx_k_import[] = "__import__";
static char __pyx_k_n_ceps[] = "n_ceps";
...
static PyObject *__pyx_n_s_acoeff;
...
static PyObject *__pyx_n_s_n_ceps;
...
/* "ldc_wavlib/features/_plp.pyx":12
...
static PyObject *__pyx_pw_10ldc_wavlib_8features_4_plp_1acorr(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyObject *__pyx_f_10ldc_wavlib_8features_4_plp_acorr(__Pyx_memviewslice __pyx_v_x, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "ldc_wavlib/features/_plp.pyx":30
 * 
 *     # allocate array
 *     nr = x.shape[0];             # <<<<<<<<<<<<<<
 *     nc = x.shape[1];
 ...
 */
  ...
  /* "ldc_wavlib/features/_plp.pyx":31
 *     # allocate array
 *     nr = x.shape[0];
 *     nc = x.shape[1];             # <<<<<<<<<<<<<<
 *     corr = np.empty([nr, nc], dtype='float32');
 ...
 */
  ...
  /* "ldc_wavlib/features/_plp.pyx":32
 *     nr = x.shape[0];
 *     nc = x.shape[1];
 *     corr = np.empty([nr, nc], dtype='float32');             # <<<<<<<<<<<<<<
 *     cdef float[:, :] corr_mv = corr
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_nr); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_nc); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_n_s_float32) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "ldc_wavlib/features/_plp.pyx":33
 *     nc = x.shape[1];
 *     corr = np.empty([nr, nc], dtype='float32');
 *     cdef float[:, :] corr_mv = corr             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (unlikely(!__pyx_t_5.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_corr_mv = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "ldc_wavlib/features/_plp.pyx":36
 * 
 *     # compute
 *     for ii in xrange(nr):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "ldc_wavlib/features/_plp.pyx":37
 *     # compute
 *     for ii in xrange(nr):
 *         for lag in xrange(nc):             # <<<<<<<<<<<<<<
 *             accum = 0.0;
 ...
 */
    ...
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      ...
      /* "ldc_wavlib/features/_plp.pyx":38
 *     for ii in xrange(nr):
 *         for lag in xrange(nc):
 *             accum = 0.0;             # <<<<<<<<<<<<<<
 *             for jj in xrange(nc - lag):
 ...
 */
      ...
      /* "ldc_wavlib/features/_plp.pyx":39
 *         for lag in xrange(nc):
 *             accum = 0.0;
 *             for jj in xrange(nc - lag):             # <<<<<<<<<<<<<<
 *                 accum += x[ii, jj]*x[ii, jj+lag];
 ...
 */
      ...
      for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
        ...
        /* "ldc_wavlib/features/_plp.pyx":40
 *             accum = 0.0;
 *             for jj in xrange(nc - lag):
 *                 accum += x[ii, jj]*x[ii, jj+lag];             # <<<<<<<<<<<<<<
 *             corr_mv[ii, lag] = accum;
 ...
 */
      ...
      /* "ldc_wavlib/features/_plp.pyx":41
 *             for jj in xrange(nc - lag):
 *                 accum += x[ii, jj]*x[ii, jj+lag];
 *             corr_mv[ii, lag] = accum;             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ldc_wavlib/features/_plp.pyx":43
 *             corr_mv[ii, lag] = accum;
 * 
 *     return corr;             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("ldc_wavlib.features._plp.acorr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_10ldc_wavlib_8features_4_plp_1acorr(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static char __pyx_doc_10ldc_wavlib_8features_4_plp_acorr[] = "Compute autocorrelation sequence for rows of a 2-D array.\n\n    For each row of x, compute the cross-correlation of the row with\n    itself at lags from 0 to n_cols - 1;\n\n    Input:\n        x:    2-D numpy array\n\n    Output:\n        corr: 2-D numpy array, the i-th row of which is the\n              autocorrelation sequence of the i-th row of x.\n    ";
static PyObject *__pyx_pw_10ldc_wavlib_8features_4_plp_1acorr(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  ...
  assert(__pyx_arg_x); {
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(__pyx_arg_x); if (unlikely(!__pyx_v_x.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  ...
  __pyx_r = __pyx_pf_10ldc_wavlib_8features_4_plp_acorr(__pyx_self, __pyx_v_x);
...
static PyObject *__pyx_pf_10ldc_wavlib_8features_4_plp_acorr(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("acorr", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_x.memview)) { __Pyx_RaiseUnboundLocalError("x"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  __pyx_t_1 = __pyx_f_10ldc_wavlib_8features_4_plp_acorr(__pyx_v_x, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_10ldc_wavlib_8features_4_plp_3levinson(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_10ldc_wavlib_8features_4_plp_levinson(__Pyx_memviewslice __pyx_v_r, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_10ldc_wavlib_8features_4_plp_levinson *__pyx_optional_args) {
  ...
  /* "ldc_wavlib/features/_plp.pyx":74
 * 
 *     # determine order
 *     nr = r.shape[0];             # <<<<<<<<<<<<<<
 *     nc = r.shape[1];
 ...
 */
  ...
  /* "ldc_wavlib/features/_plp.pyx":75
 *     # determine order
 *     nr = r.shape[0];
 *     nc = r.shape[1];             # <<<<<<<<<<<<<<
 *     if n is None:
 ...
 */
  ...
  /* "ldc_wavlib/features/_plp.pyx":76
 *     nr = r.shape[0];
 *     nc = r.shape[1];
 *     if n is None:             # <<<<<<<<<<<<<<
 *         order = nc-1;
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "ldc_wavlib/features/_plp.pyx":77
 *     nc = r.shape[1];
 *     if n is None:
 *         order = nc-1;             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "ldc_wavlib/features/_plp.pyx":79
 *         order = nc-1;
 *     else:
 *         order = n;             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_3 = __Pyx_PyInt_As_unsigned_int(__pyx_v_n); if (unlikely((__pyx_t_3 == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_v_order = __pyx_t_3;
  }
  __pyx_L3:;

  /* "ldc_wavlib/features/_plp.pyx":82
 * 
 *     # allocate memory and set memory views
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_empty); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_unsigned_int(__pyx_v_nr); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyInt_From_long((__pyx_v_order + 1)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = PyList_New(2); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_7, __pyx_n_s_dtype, __pyx_t_8) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_6, __pyx_t_7); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  ...
  /* "ldc_wavlib/features/_plp.pyx":83
 *     # allocate memory and set memory views
 *     acoeff = np.empty([nr, order+1], dtype=np.float32); # LP coefficients
 *     tmp_acoeff = np.empty(order+1, dtype=np.float32);             # <<<<<<<<<<<<<<
 *     error = np.zeros(nr, dtype=np.float32);
 ...
 */
  __pyx_t_8 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_empty); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyInt_From_long((__pyx_v_order + 1)); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  ...
  __pyx_t_8 = 0;
  __pyx_t_8 = PyDict_New(); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_float32); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_dtype, __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_6, __pyx_t_8); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  ...
  /* "ldc_wavlib/features/_plp.pyx":84
 *     acoeff = np.empty([nr, order+1], dtype=np.float32); # LP coefficients
 *     tmp_acoeff = np.empty(order+1, dtype=np.float32);
 *     error = np.zeros(nr, dtype=np.float32);             # <<<<<<<<<<<<<<
 *     cdef float[:, :] acoeff_mv = acoeff
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_float32); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_6, __pyx_t_4); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  /* "ldc_wavlib/features/_plp.pyx":85
 *     tmp_acoeff = np.empty(order+1, dtype=np.float32);
 *     error = np.zeros(nr, dtype=np.float32);
 *     cdef float[:, :] acoeff_mv = acoeff             # <<<<<<<<<<<<<<
 *     cdef float[:] error_mv = error
 ...
 */
  ...
  /* "ldc_wavlib/features/_plp.pyx":86
 *     error = np.zeros(nr, dtype=np.float32);
 *     cdef float[:, :] acoeff_mv = acoeff
 *     cdef float[:] error_mv = error             # <<<<<<<<<<<<<<
 *     cdef float[:] tmp_acoeff_mv = tmp_acoeff
 ...
 */
  ...
  /* "ldc_wavlib/features/_plp.pyx":87
 *     cdef float[:, :] acoeff_mv = acoeff
 *     cdef float[:] error_mv = error
 *     cdef float[:] tmp_acoeff_mv = tmp_acoeff             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (unlikely(!__pyx_t_11.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_tmp_acoeff_mv = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;

  /* "ldc_wavlib/features/_plp.pyx":90
 * 
 *     # compute LP coefficients
 *     for ii in xrange(nr):             # <<<<<<<<<<<<<<
 *         error_mv[ii] = r[ii, 0];
 ...
 */
  ...
  for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_3; __pyx_t_12+=1) {
    ...
    /* "ldc_wavlib/features/_plp.pyx":91
 *     # compute LP coefficients
 *     for ii in xrange(nr):
 *         error_mv[ii] = r[ii, 0];             # <<<<<<<<<<<<<<
 *         acoeff_mv[ii, 0] = 1.0;   # order 0
 ...
 */
    ...
    *((float *) ( /* dim=0 */ (__pyx_v_error_mv.data + __pyx_t_15 * __pyx_v_error_mv.strides[0]) )) = (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_r.data + __pyx_t_13 * __pyx_v_r.strides[0]) ) + __pyx_t_14 * __pyx_v_r.strides[1]) )));
    ...
    /* "ldc_wavlib/features/_plp.pyx":92
 *     for ii in xrange(nr):
 *         error_mv[ii] = r[ii, 0];
 *         acoeff_mv[ii, 0] = 1.0;   # order 0             # <<<<<<<<<<<<<<
 *         for jj in xrange(1, order+1):
 ...
 */
    ...
    *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acoeff_mv.data + __pyx_t_16 * __pyx_v_acoeff_mv.strides[0]) ) + __pyx_t_17 * __pyx_v_acoeff_mv.strides[1]) )) = 1.0;
    ...
    /* "ldc_wavlib/features/_plp.pyx":93
 *         error_mv[ii] = r[ii, 0];
 *         acoeff_mv[ii, 0] = 1.0;   # order 0
 *         for jj in xrange(1, order+1):             # <<<<<<<<<<<<<<
 *             # next reflection coefficient
 ...
 */
    ...
    for (__pyx_t_19 = 1; __pyx_t_19 < __pyx_t_18; __pyx_t_19+=1) {
      ...
      /* "ldc_wavlib/features/_plp.pyx":95
 *         for jj in xrange(1, order+1):
 *             # next reflection coefficient
 *             kcoeff = r[ii, jj];             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "ldc_wavlib/features/_plp.pyx":96
 *             # next reflection coefficient
 *             kcoeff = r[ii, jj];
 *             for kk in xrange(1, jj):             # <<<<<<<<<<<<<<
 *                 kcoeff += acoeff_mv[ii, kk]*r[ii, jj-kk];
 ...
 */
      ...
      for (__pyx_t_23 = 1; __pyx_t_23 < __pyx_t_22; __pyx_t_23+=1) {
        ...
        /* "ldc_wavlib/features/_plp.pyx":97
 *             kcoeff = r[ii, jj];
 *             for kk in xrange(1, jj):
 *                 kcoeff += acoeff_mv[ii, kk]*r[ii, jj-kk];             # <<<<<<<<<<<<<<
 *             kcoeff = -kcoeff / error_mv[ii];
 ...
 */
      ...
      /* "ldc_wavlib/features/_plp.pyx":98
 *             for kk in xrange(1, jj):
 *                 kcoeff += acoeff_mv[ii, kk]*r[ii, jj-kk];
 *             kcoeff = -kcoeff / error_mv[ii];             # <<<<<<<<<<<<<<
 *             acoeff_mv[ii, jj] = kcoeff;
 ...
 */
      ...
      __pyx_v_kcoeff = ((-__pyx_v_kcoeff) / (*((float *) ( /* dim=0 */ (__pyx_v_error_mv.data + __pyx_t_22 * __pyx_v_error_mv.strides[0]) ))));

      /* "ldc_wavlib/features/_plp.pyx":99
 *                 kcoeff += acoeff_mv[ii, kk]*r[ii, jj-kk];
 *             kcoeff = -kcoeff / error_mv[ii];
 *             acoeff_mv[ii, jj] = kcoeff;             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acoeff_mv.data + __pyx_t_23 * __pyx_v_acoeff_mv.strides[0]) ) + __pyx_t_28 * __pyx_v_acoeff_mv.strides[1]) )) = __pyx_v_kcoeff;

      /* "ldc_wavlib/features/_plp.pyx":102
 * 
 *             # new LP coefficients
 ...
 */
        ...
        *((float *) ( /* dim=0 */ (__pyx_v_tmp_acoeff_mv.data + __pyx_t_33 * __pyx_v_tmp_acoeff_mv.strides[0]) )) = (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acoeff_mv.data + __pyx_t_31 * __pyx_v_acoeff_mv.strides[0]) ) + __pyx_t_32 * __pyx_v_acoeff_mv.strides[1]) )));
      }

      /* "ldc_wavlib/features/_plp.pyx":104
 *             for kk in xrange(order):
 *                 tmp_acoeff_mv[kk] = acoeff_mv[ii, kk];
 *             for kk in xrange(1, jj):             # <<<<<<<<<<<<<<
 *                 acoeff_mv[ii, kk] += kcoeff*tmp_acoeff_mv[jj-kk];
 ...
 */
      ...
      for (__pyx_t_30 = 1; __pyx_t_30 < __pyx_t_29; __pyx_t_30+=1) {
        ...
        /* "ldc_wavlib/features/_plp.pyx":105
 *                 tmp_acoeff_mv[kk] = acoeff_mv[ii, kk];
 *             for kk in xrange(1, jj):
 *                 acoeff_mv[ii, kk] += kcoeff*tmp_acoeff_mv[jj-kk];             # <<<<<<<<<<<<<<
 * 
 *             # new error
 */
        __pyx_t_34 = (__pyx_v_jj - __pyx_v_kk);
        __pyx_t_35 = __pyx_v_ii;
        __pyx_t_36 = __pyx_v_kk;
        *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acoeff_mv.data + __pyx_t_35 * __pyx_v_acoeff_mv.strides[0]) ) + __pyx_t_36 * __pyx_v_acoeff_mv.strides[1]) )) += (__pyx_v_kcoeff * (*((float *) ( /* dim=0 */ (__pyx_v_tmp_acoeff_mv.data + __pyx_t_34 * __pyx_v_tmp_acoeff_mv.strides[0]) ))));
      }

      /* "ldc_wavlib/features/_plp.pyx":108
 * 
 *             # new error
 ...
 */
      ...
      *((float *) ( /* dim=0 */ (__pyx_v_error_mv.data + __pyx_t_29 * __pyx_v_error_mv.strides[0]) )) *= (1.0 - (__pyx_v_kcoeff * __pyx_v_kcoeff));
    }
  }

  /* "ldc_wavlib/features/_plp.pyx":110
 *             error_mv[ii] *= 1 - kcoeff*kcoeff;
 * 
 *     return acoeff, error;             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("ldc_wavlib.features._plp.levinson", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_10ldc_wavlib_8features_4_plp_3levinson(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_10ldc_wavlib_8features_4_plp_2levinson[] = "Find coefficients of autoregressive linear process by\n    Levinson-Durbin recursion.\n\n    Inputs:\n        r: Autocorrelation sequence of process. If 2-D, each\n           row is treated as being from a separate process.\n\n        n: Order of denominator polynomial. If None, order is set\n           to r.shape[0]-1\n           (Default: None)\n\n    Outputs:\n        acoeff: coefficients of autoregressive model\n\n        error: prediction error\n    ";
static PyObject *__pyx_pw_10ldc_wavlib_8features_4_plp_3levinson(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("levinson (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "levinson") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_r = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[0]); if (unlikely(!__pyx_v_r.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_n = values[1];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("levinson", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("ldc_wavlib.features._plp.levinson", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10ldc_wavlib_8features_4_plp_2levinson(__pyx_self, __pyx_v_r, __pyx_v_n);
...
static PyObject *__pyx_pf_10ldc_wavlib_8features_4_plp_2levinson(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_r, PyObject *__pyx_v_n) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_10ldc_wavlib_8features_4_plp_levinson __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("levinson", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_r.memview)) { __Pyx_RaiseUnboundLocalError("r"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.n = __pyx_v_n;
  __pyx_t_1 = __pyx_f_10ldc_wavlib_8features_4_plp_levinson(__pyx_v_r, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "ldc_wavlib/features/_plp.pyx":115
 * @cython.boundscheck(False) # turn of bounds-checking for entire function
 * @cython.wraparound(False) # turn off negative-indices for entire function
...
static PyObject *__pyx_pw_10ldc_wavlib_8features_4_plp_5lpc_2_cepstrum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_10ldc_wavlib_8features_4_plp_lpc_2_cepstrum(__Pyx_memviewslice __pyx_v_acoeff, __Pyx_memviewslice __pyx_v_e, unsigned int __pyx_v_n_ceps, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  __Pyx_memviewslice __pyx_v_Cxy_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("lpc_2_cepstrum", 0);

  /* "ldc_wavlib/features/_plp.pyx":125
 * 
 *     # allocate memory
 ...
 */
  __pyx_v_n_frames = (__pyx_v_acoeff.shape[0]);

  /* "ldc_wavlib/features/_plp.pyx":126
 *     # allocate memory
 *     n_frames = acoeff.shape[0];
 *     Cxy = np.empty([n_frames, n_ceps], dtype='float32');             # <<<<<<<<<<<<<<
 *     cdef float [:, :] Cxy_mv = Cxy
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n_frames); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n_ceps); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyList_New(2); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  PyList_SET_ITEM(__pyx_t_4, 0, __pyx_t_1);
  __Pyx_GIVEREF(__pyx_t_1);
  PyList_SET_ITEM(__pyx_t_4, 1, __pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_n_s_float32) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  /* "ldc_wavlib/features/_plp.pyx":127
 *     n_frames = acoeff.shape[0];
 *     Cxy = np.empty([n_frames, n_ceps], dtype='float32');
 *     cdef float [:, :] Cxy_mv = Cxy             # <<<<<<<<<<<<<<
 * 
 *     # convert
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(__pyx_v_Cxy);
  if (unlikely(!__pyx_t_5.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_Cxy_mv = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "ldc_wavlib/features/_plp.pyx":130
 * 
 *     # convert
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "ldc_wavlib/features/_plp.pyx":131
 *     # convert
 *     for ii in xrange(n_frames):
 *         Cxy_mv[ii, 0] = log(e[ii]);             # <<<<<<<<<<<<<<
 *         for jj in xrange(1, n_ceps):
 ...
 */
    ...
    __pyx_t_10 = 0;
    *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Cxy_mv.data + __pyx_t_9 * __pyx_v_Cxy_mv.strides[0]) ) + __pyx_t_10 * __pyx_v_Cxy_mv.strides[1]) )) = log((*((float *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_8 * __pyx_v_e.strides[0]) ))));

    /* "ldc_wavlib/features/_plp.pyx":132
 *     for ii in xrange(n_frames):
 *         Cxy_mv[ii, 0] = log(e[ii]);
 *         for jj in xrange(1, n_ceps):             # <<<<<<<<<<<<<<
 *             accum = 0.0;
 ...
 */
      ...
      /* "ldc_wavlib/features/_plp.pyx":134
 *         for jj in xrange(1, n_ceps):
 *             accum = 0.0;
 *             for kk in xrange(1, jj+1):             # <<<<<<<<<<<<<<
 *                 accum += (jj - kk)*acoeff[ii, kk]*Cxy_mv[ii, jj - kk];
 ...
 */
      ...
      for (__pyx_t_14 = 1; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
        ...
        /* "ldc_wavlib/features/_plp.pyx":135
 *             accum = 0.0;
 *             for kk in xrange(1, jj+1):
 *                 accum += (jj - kk)*acoeff[ii, kk]*Cxy_mv[ii, jj - kk];             # <<<<<<<<<<<<<<
 *             Cxy_mv[ii, jj] = -(acoeff[ii, kk] + accum / jj);
 ...
 */
        ...
        __pyx_t_18 = (__pyx_v_jj - __pyx_v_kk);
        __pyx_v_accum = (__pyx_v_accum + (((__pyx_v_jj - __pyx_v_kk) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acoeff.data + __pyx_t_15 * __pyx_v_acoeff.strides[0]) ) + __pyx_t_16 * __pyx_v_acoeff.strides[1]) )))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Cxy_mv.data + __pyx_t_17 * __pyx_v_Cxy_mv.strides[0]) ) + __pyx_t_18 * __pyx_v_Cxy_mv.strides[1]) )))));
      }

      /* "ldc_wavlib/features/_plp.pyx":136
 *             for kk in xrange(1, jj+1):
 *                 accum += (jj - kk)*acoeff[ii, kk]*Cxy_mv[ii, jj - kk];
 *             Cxy_mv[ii, jj] = -(acoeff[ii, kk] + accum / jj);             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_20 = __pyx_v_ii;
      __pyx_t_21 = __pyx_v_jj;
      *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Cxy_mv.data + __pyx_t_20 * __pyx_v_Cxy_mv.strides[0]) ) + __pyx_t_21 * __pyx_v_Cxy_mv.strides[1]) )) = (-((*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_acoeff.data + __pyx_t_14 * __pyx_v_acoeff.strides[0]) ) + __pyx_t_19 * __pyx_v_acoeff.strides[1]) ))) + (__pyx_v_accum / __pyx_v_jj)));
    }
  }

  /* "ldc_wavlib/features/_plp.pyx":138
 *             Cxy_mv[ii, jj] = -(acoeff[ii, kk] + accum / jj);
 * 
 *     return Cxy             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_4);
  __PYX_XDEC_MEMVIEW(&__pyx_t_5, 1);
  __Pyx_AddTraceback("ldc_wavlib.features._plp.lpc_2_cepstrum", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_Cxy);
  __PYX_XDEC_MEMVIEW(&__pyx_v_Cxy_mv, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_10ldc_wavlib_8features_4_plp_5lpc_2_cepstrum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_10ldc_wavlib_8features_4_plp_4lpc_2_cepstrum[] = "\n    ";
static PyObject *__pyx_pw_10ldc_wavlib_8features_4_plp_5lpc_2_cepstrum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_acoeff = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_e = { 0, 0, { 0 }, { 0 }, { 0 } };
  unsigned int __pyx_v_n_ceps;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("lpc_2_cepstrum (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_acoeff,&__pyx_n_s_e,&__pyx_n_s_n_ceps,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_acoeff)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_e)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lpc_2_cepstrum", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n_ceps)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lpc_2_cepstrum", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "lpc_2_cepstrum") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_acoeff = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[0]); if (unlikely(!__pyx_v_acoeff.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_e = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[1]); if (unlikely(!__pyx_v_e.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_n_ceps = __Pyx_PyInt_As_unsigned_int(values[2]); if (unlikely((__pyx_v_n_ceps == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("lpc_2_cepstrum", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("ldc_wavlib.features._plp.lpc_2_cepstrum", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10ldc_wavlib_8features_4_plp_4lpc_2_cepstrum(__pyx_self, __pyx_v_acoeff, __pyx_v_e, __pyx_v_n_ceps);
...
static PyObject *__pyx_pf_10ldc_wavlib_8features_4_plp_4lpc_2_cepstrum(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_acoeff, __Pyx_memviewslice __pyx_v_e, unsigned int __pyx_v_n_ceps) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("lpc_2_cepstrum", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_acoeff.memview)) { __Pyx_RaiseUnboundLocalError("acoeff"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  if (unlikely(!__pyx_v_e.memview)) { __Pyx_RaiseUnboundLocalError("e"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  __pyx_t_1 = __pyx_f_10ldc_wavlib_8features_4_plp_lpc_2_cepstrum(__pyx_v_acoeff, __pyx_v_e, __pyx_v_n_ceps, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_acoeff, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  __Pyx_NAMESTR("ldc_wavlib.features._plp.array"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("ldc_wavlib.features._plp.Enum"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("ldc_wavlib.features._plp.memoryview"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("ldc_wavlib.features._plp._memoryviewslice"), /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("acorr"), (PyCFunction)__pyx_pw_10ldc_wavlib_8features_4_plp_1acorr, METH_O, __Pyx_DOCSTR(__pyx_doc_10ldc_wavlib_8features_4_plp_acorr)},
  {__Pyx_NAMESTR("levinson"), (PyCFunction)__pyx_pw_10ldc_wavlib_8features_4_plp_3levinson, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_10ldc_wavlib_8features_4_plp_2levinson)},
  {__Pyx_NAMESTR("lpc_2_cepstrum"), (PyCFunction)__pyx_pw_10ldc_wavlib_8features_4_plp_5lpc_2_cepstrum, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_10ldc_wavlib_8features_4_plp_4lpc_2_cepstrum)},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_acoeff, __pyx_k_acoeff, sizeof(__pyx_k_acoeff), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_n_ceps, __pyx_k_n_ceps, sizeof(__pyx_k_n_ceps), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_plp(void); /*proto*/
PyMODINIT_FUNC init_plp(void)
#else
PyMODINIT_FUNC PyInit__plp(void); /*proto*/
PyMODINIT_FUNC PyInit__plp(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__plp(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_plp"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_ldc_wavlib__features___plp) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "ldc_wavlib.features._plp")) {
      if (unlikely(PyDict_SetItemString(modules, "ldc_wavlib.features._plp", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "ldc_wavlib/features/_plp.pyx":2
 * import cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 */
  ...
  /* "ldc_wavlib/features/_plp.pyx":1
 * import cython             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init ldc_wavlib.features._plp", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ldc_wavlib.features._plp");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
